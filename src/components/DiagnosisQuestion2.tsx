    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#003366] via-[#003366] to-[#002244] font-inter px-6 py-8 pt-20 pb-40">
        ...
        <div className="w-full max-w-2xl mx-auto">
          ...
          <form id="diagnosis-q2-form" onSubmit={handleSubmit}>
            ...
            <p className="text-white/50 text-sm mb-8 animate-fade-in-delay-1">
              Dinheiro para cobrir seus custos caso perca renda
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 animate-slide-up-delay-1">
              ...
              >
                ...
                <input type="radio" name="hasEmergencyFund" value="true" checked={answer === true} onChange={() => setAnswer(true)} className="sr-only" />
              </button>
              ...
              >
                <div className={`w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 ${
                  ...
                  <ShieldX className={`w-6 h-6 transition-colors ${
                ...
                <input type="radio" name="hasEmergencyFund" value="false" checked={answer === false} onChange={() => setAnswer(false)} className="sr-only" />
              </button>
            </div>
          </form>
        </div>
