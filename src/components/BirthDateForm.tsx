  ...
  return (
    <>
      ...
      <div className="w-full max-w-2xl mx-auto">
        ...
        <div className="mb-6">
          <h1 className="text-2xl md:text-3xl font-funnel font-bold text-white mb-2">
            Quando você nasceu?
          </h1>
        </div>
            ...
            <div className="flex gap-3 items-end">
              <div className="flex-1">
                ...
                <input
                  ...
                  placeholder="DD"
                  className={`w-full px-3 py-3 border border-white/20 rounded-lg focus:ring-2 focus:border-transparent text-center text-lg font-medium bg-white/10 text-white placeholder:text-white/40 ${
                    error
                      ? 'border-red-300 focus:ring-red-500'
                      : 'border-white/20 focus:ring-[#F2C94C]'
                  }`}
                />
              </div>
              ...
              <div className="flex-1">
                ...
                <select
                  ...
                  className={`w-full px-3 py-3 border rounded-lg focus:ring-2 focus:border-transparent text-lg font-medium appearance-none bg-white/10 text-white cursor-pointer ${
                    error
                      ? 'border-red-300 focus:ring-red-500'
                      : 'border-white/20 focus:ring-[#F2C94C]'
                  }`}
